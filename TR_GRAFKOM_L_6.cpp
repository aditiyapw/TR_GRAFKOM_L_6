...
void tampil(void)
{
    ...
    //bendera
    glBegin(GL_POLYGON);
    glColor3f(239/255.0f, 197/255.0f, 0/255.0f);
    glVertex3f(-50,-26,29.9);
    glVertex3f(-49,-26,29.9);
    glVertex3f(-49,-25.5,29.9);
    glVertex3f(-50,-25.5,29.9);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(239/255.0f, 51/255.0f, 0/255.0f);
    glVertex3f(-50,-25.5,29.9);
    glVertex3f(-49,-25.5,29.9);
    glVertex3f(-49,-25,29.9);
    ...
    glColor3f(239/255.0f, 197/255.0f, 0/255.0f);
    glVertex3f(50,-26,29.9);
    glVertex3f(51,-26,29.9);
    glVertex3f(51,-25.5,29.9);
    glVertex3f(50,-25.5,29.9);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(239/255.0f, 51/255.0f, 0/255.0f);
    ...
    glBegin(GL_POLYGON);
    glColor3f(35/255.0f, 35/255.0f, 35/255.0f);
    glVertex3f(60,-30,-65);
    glVertex3f(-50,-30,-65);
    glVertex3f(-50,-8,-65);
    glVertex3f(60,-8,-65);
    ...
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(135/255.0f, 135/255.0f, 135/255.0f);
    glVertex3f(-50,-30,55);
    glVertex3f(-50,-16,55);
    glVertex3f(-50,-16,57);
    glVertex3f(-50,-30,57);
    ...
    //tembok besar kanan
    glBegin(GL_POLYGON);
    glColor3f(115/255.0f, 115/255.0f, 115/255.0f);
    glVertex3f(60,-30,-65);
    glVertex3f(60,-15,-65);
    glVertex3f(60,-15,65);
    glVertex3f(60,-30,65);
    ...
    glBegin(GL_POLYGON);
    glColor3f(60/255.0f, 60/255.0f, 60/255.0f);
    glVertex3f(60.1,-30,-65);
    glVertex3f(60.1,-15,-65);
    glVertex3f(60.1,-15,65);
    glVertex3f(60.1,-30,65);
    glEnd();
    glBegin(GL_POLYGON);
    glColor3f(90/255.0f, 90/255.0f, 90/255.0f);
    glVertex3f(-76,-16,33);
    glVertex3f(-50,-16,56);
    glVertex3f(-50,-30,56);
    glVertex3f(-76,-30,33);
